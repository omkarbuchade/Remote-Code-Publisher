...
* ----------------------
*  ver 1.1: 4/30/2019
*  - Added methods in cpp file to add functionality to publish and
*    download files for the client.
*  ver 1.0 : 3/27/2018
*  - first release
*/
#include <vector>
...
namespace Repository
{
  ...
  SearchPath storageRoot;// = "../Project4";  // root for all server file storage
